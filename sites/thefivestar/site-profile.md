...
| 🟡 Med | Velocity Elementor at canonical staging slug (page 5107 since 2026-04-27) | Pending Phase 3.11 production promotion ⏳ |
...
| 🟡 Med | Communities hub Elementor at canonical staging slug (page 5108 since 2026-04-28 PM via in-place swap; revised post-Jonathan-flow-correction to drop AMDC + MortgagePoint + membership logos; community-level copy + Memberships funnel CTA) | Pending Phase 4b-hub.11 production promotion ⏳ |
